...
class SpinDiscPainter extends CustomPainter {
  final List<SpinDiscSector> sectors;
  ...
  // Exposed so SpinDiscWidget can compute canvas size & arrow position
  ...
  @override
  bool shouldRepaint(covariant SpinDiscPainter old) =>
