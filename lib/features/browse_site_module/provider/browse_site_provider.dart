...
class BrowseSiteProvider extends ChangeNotifier {
  int get _missionSeconds => RemoteSettingsService.instance.websiteVisitTimer;
  static int lockMinutes = RemoteSettingsService.instance.websiteLockMinutes;
  int get _rewardCoins => RemoteSettingsService.instance.websiteRewardCoins;
