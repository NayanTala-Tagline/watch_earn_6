...
import 'package:daily_cash/features/leaderboard_module/provider/leaderboard_provider.dart';
        ...
        child: Consumer<LeaderboardProvider>(
          builder: (context, provider, _) {
            return Scaffold(
              ...
              appBar: CommonAppBar(title: context.l10n.leaderboard, showLeading: false),
                      ...
                      : RefreshIndicator(
                          ...
                          child: CustomScrollView(
                            slivers: [
                              SliverToBoxAdapter(
                                child: Padding(
                                  padding: EdgeInsets.fromLTRB(
                                      AppSize.w20, AppSize.h20, AppSize.w20, AppSize.h30),
                                  child: Column(
                                    children: [
                                      // ── Podium ──────────────────────────────
                                      Row(
                              ...
                              SliverToBoxAdapter(child: SizedBox(height: AppSize.h20)),
                            ],
                          ),
                        ),
            );
