...
class PurseBottomSheet extends StatelessWidget {
  final PurseItem item;
  const PurseBottomSheet({super.key, required this.item});
...
Widget _buildTextField(
  ...
  return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        suffixText: suffix
            ? "${rootNavKey.currentContext!.l10n.min} ${RemoteSettingsService.instance.minWithdrawAmount}"
            : null,
