...
import 'package:daily_cash/utils/app_string.dart';
...
class WalletHistoryScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CommonAppBar(title: rootNavKey.currentContext!.l10n.withdrawHistory),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (status == AppStrings.isRejected && reason != null) ...[
                          const SizedBox(height: 10),
                          _MetaRow(
                        ...
                        if (status == AppStrings.isApproved) ...[
                          const SizedBox(height: 10),
                          _MetaRow(
                        ...
                        // Pending note
                        if (status == AppStrings.isPending) ...[
                          const SizedBox(height: 10),
                          _MetaRow(
