...
import 'package:daily_cash/features/onboarding_module/onboarding_screen/model/onboarding_model.dart';
...
class OnboardingProvider extends ChangeNotifier {
  ...
  Future<void> loadOnboarding1Ads() async {
    nativeAd1 = NativeAdManager(adData: RemoteConfigService.instance.onboardingNative1);
    interAd1 = InterstitialAdManager(adData: RemoteConfigService.instance.onboardingInter1);
  ...
  Future<void> loadOnboarding2Ads() async {
    nativeAd2 = NativeAdManager(adData: RemoteConfigService.instance.onboardingNative2);
    interAd2 = InterstitialAdManager(adData: RemoteConfigService.instance.onboardingInter2);
  ...
  Future<void> loadOnboarding3Ads() async {
    nativeAd3 = NativeAdManager(adData: RemoteConfigService.instance.onboardingNative3);
    interAd3 = InterstitialAdManager(adData: RemoteConfigService.instance.onboardingInter3);
