...
class AchievementProvider extends ChangeNotifier {
  final List<AchievementItem> achievements = [
    AchievementItem(
      ...
      reward: 50,
      isLocked: true,
      icon: Assets.icons.quizChampion.svg(width: AppSize.w24),
    ),
    AchievementItem(
      title: 'Lucky Spinner',
      ...
      reward: 50,
      isLocked: true,
      icon: Assets.icons.rotatingWheel.svg(width: AppSize.w24),
    ),
    AchievementItem(
    ...
    AchievementItem(
      ...
      reward: 50,
      isLocked: true,
      icon: Assets.icons.tokens.svg(width: AppSize.w24),
    ),
    AchievementItem(
      title: 'Quiz Master',
