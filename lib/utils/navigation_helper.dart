...
import 'package:daily_cash/widgets/loading_overlay/loading_overlay.dart';
...
class NavigationHelper {
  ...
  factory NavigationHelper() => _singleton;
  ...
  Future<void> _handleAdSequence(
    ...
    final adData = RemoteConfigService.instance.appInter;
    ...
    try {
      ...
      if (overlayVisible) LoadingOverlay.instance().hide();
