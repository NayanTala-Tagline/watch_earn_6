...
class RemoteSettingsService {
  static final RemoteSettingsService _singleton = RemoteSettingsService._internal();

  factory RemoteSettingsService() => _singleton;

  static RemoteSettingsService get instance => _singleton;

  final FirebaseRemoteConfig _firebaseRemoteConfig = FirebaseRemoteConfig.instance;
  Map<String, dynamic> _appConfig = {};
  Map<String, dynamic> _visitSites = {};

  RemoteSettingsService._internal();
